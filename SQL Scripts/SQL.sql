...
-- Constraints
	constraint category_constraint_course_id_and_category_primary_key primary key(course_id,category),
);
...
create table [course_media_file]
(
-- Attributes
	course_id int not null ,
...
-- Constraints
	...
	constraint course_media_file_constraint_course_id_foreign_key foreign key(course_id) references [course](id),
	constraint course_media_file_constraint_media_file_id_foreign_key foreign key(media_file_id) references [media_file](id),
);
...
-- Constraints
	...
	constraint enrollment_constraint_course_id_foreign_key foreign key(course_id) references [course](id),
...
-- Constraints
	...
	constraint notification_constraint_course_id_foreign_key foreign key(course_id) references [course](id),
	constraint notification_constraint_user_id_foreign_key foreign key(user_id) references [user](id),
...
-- Constraints
	...
	constraint lesson_constraint_course_id_foreign_key foreign key(course_id) references [course](id),
...
-- Constraints
	...
	constraint attendance_constraint_lesson_id_foreign_key foreign key(lesson_id) references [lesson](id),
	constraint attendance_constraint_student_id_foreign_key foreign key(student_id) references [user](id),
...
-- Constraints
	...
	constraint quiz_constraint_course_id_foreign_key foreign key(course_id) references [course](id),
...
-- Constraints
	constraint question_choice_constraint_question_id_foreign_key foreign key(question_id) references [question](id),
...
-- Attributes
	...
	question_id int not null,
-- Constraints
	constraint quiz_question_constraint_quiz_id_foreign_key foreign key(quiz_id) references [quiz](id),
	constraint quiz_question_constraint_question_id_foreign_key foreign key(question_id) references [question](id),
...
-- Attributes
	...
	question_id int not null,
-- Constraints
	constraint bank_question_constraint_course_id_foreign_key foreign key(course_id) references [course](id),
	constraint bank_question_constraint_question_id_foreign_key foreign key(question_id) references [question](id),
...
-- Constraints
	...
	constraint assignment_constraint_course_id_foreign_key foreign key(course_id) references [course](id),
...
create table [submission_media_file]
(
-- Attributes
	media_file_id int not null,
	submission_id int not null,
-- Constraints
	constraint submission_media_file_constraint_media_file_id_foreign_key foreign key(media_file_id) references [media_file](id),
	constraint submission_media_file_constraint_submission_id_foreign_key foreign key(submission_id) references [submission](id),
...
-- Constraints
	...
	constraint submission_assignment_constraint_student_id_foreign_key foreign key(student_id) references [user](id),
	constraint submission_assignment_constraint_assignment_id_foreign_key foreign key(assignment_id) references [assignment](id),
	constraint submission_assignment_constraint_submission_id_foreign_key foreign key(submission_id) references [submission](id),
